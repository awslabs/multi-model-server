...
def predict():
    output = subprocess.check_output('curl -X POST http://127.0.0.1:8080/resnet-18/predict -F "data=@cat.jpg"', shell=True)
...
def logging():
    ...
    expected_log = "Initialized model serving.\n" \
                   ...
                   "Request input: data should be image with jpeg format.\n" \
