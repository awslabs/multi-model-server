...
def setup_onnx_integ(tmpdir,onnx_model,port):
...
def create_model(tmpdir,URL,onnx_model, onnx_source_model_zoo = True):
    ...
    try:
        ...
        print('download successful for model {} '.format(onnx_model))
        # Export the model.
