...
from model_export.model_export_tool_error import ModelExportToolError
from model_export.utils.model_export_error_codes import ModelExportErrorCodes as err
...
class ModelService(object):
    ...
    def metrics_init(self, metrics_store):
...
class SingleNodeService(ModelService):
    ...
    def inference(self, data):
        ...
        try:
            ...
            raise ModelExportToolError(err.CUSTOM_SERVICE_ERROR, repr(e))
