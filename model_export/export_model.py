...
from model_export.log import get_logger
from model_export.model_service.model_service import load_service
from model_export.model_service.mxnet_model_service import MXNetBaseService, GluonImperativeBaseService
...
MMS_SERVICE_FILES = {k: os.path.splitext(v.__file__)[0] + '.py' for k, v in {
    'image/jpeg': model_export.model_service.mxnet_vision_service,
    'application/json': model_export.model_service.mxnet_model_service
}.items()}
...
MODEL_ARCHIVE_VERSION = model_export.__version__
